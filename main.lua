...
Text="",
RichText=true,
TextColor3=Color3.new(0.1,0.1,0.1), -- 文字加深
TextSize=14,
},
TextButton={
BackgroundColor3=Color3.new(1,1,1),
...
TextBox={
BackgroundColor3=Color3.new(1,1,1),
BorderColor3=Color3.new(0.8,0.8,0.8), -- 边框浅化
...
ScrollingFrame={
ScrollBarImageTransparency=0.8, -- 滚动条半透明
ScrollBarThickness=6, -- 滚动条加粗
BorderSizePixel=0,
},
VideoFrame={
BorderSizePixel=0,
...
table.insert(v,NumberSequenceKeypoint.new(A,z.Transparency or 0.1)) -- 基础透明度
end
end
...
Rotation=r and r.Rotation or 45, -- 默认45度渐变
}
if r then
...
ThemeTag={
ImageColor3="DarkGrey",
},
ImageColor3=Color3.fromHex(ab.Colors.DarkGrey),
Size=UDim2.new(1,3,1,3), -- 阴影偏移
AnchorPoint=Vector2.new(0.5,0.5),
Position=UDim2.new(0.5,0,0.5,2), -- 阴影向下
...
-- 渐变效果
ab.Gradient({
["0"]={Color=ab.GetThemeProperty("Accent",ab.Theme),Transparency=0.3},
["100"]={Color=ab.GetThemeProperty("Accent",ab.Theme),Transparency=0.8},
})
})
}),
-- 按钮边框
...
Size=UDim2.new(1,0,1,0),
ImageColor3=ah=="White"and Color3.new(0,0,0)or nil,
ImageTransparency=ah=="Primary"and.85 or.75,
...
ad(an.Frame,.047,{ImageTransparency=.92}):Play()
ad(an.Highlight,.047,{ImageTransparency=0.8}):Play()
ad(an.Shadow,.047,{ImageTransparency=0.3}):Play()
end)
ab.AddSignal(an.MouseLeave,function()
ad(an.Frame,.047,{ImageTransparency=1}):Play()
ad(an.Highlight,.047,{ImageTransparency=0.9}):Play()
ad(an.Shadow,.047,{ImageTransparency=0.2}):Play()
end)
ab.AddSignal(an.MouseButton1Down,function()
ad(an.Frame,.02,{Size=UDim2.new(0.98,0,0.98,0)}):Play()
end)
ab.AddSignal(an.MouseButton1Up,function()
ad(an.Frame,.04,{Size=UDim2.new(1,0,1,0)}):Play()
if aj then
aj:Close()()
end
if ag then
...
if af then ai.UIPadding=0 end
if af then ai.UICorner=26 end
if not af then
...
Parent=af and ad.Parent or ai.UIElements.FullScreen,
Position=UDim2.new(0.5,0,0.5,0),
AnchorPoint=Vector2.new(0.5,0.5),
AutomaticSize="XY",
ThemeTag={
...
ai.UIElements.Main,
aa.NewRoundFrame(ai.UICorner,"SquircleOutline2",{
Size=UDim2.new(1,0,1,0),
ImageTransparency=1,
ThemeTag={
ImageColor3="Outline",
...
if not af then
ac(ai.UIElements.FullScreen,0.1,{BackgroundTransparency=.3}):Play()
end
...
BackgroundTransparency=1,
Text=ag.Title,
FontFace=Font.new(ab.Font,Enum.FontWeight.SemiemiBold),
ThemeTag={
TextColor3="Text",
},
TextSize=20
